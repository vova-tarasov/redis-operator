...
import (
	...
	mRedisService "github.com/vova-tarasov/redis-operator/mocks/service/redis"
	rfservice "github.com/vova-tarasov/redis-operator/operator/redisfailover/service"
)
